...
func newDir(repo restic.Repository, node *restic.Node, ownerIsRoot bool, sizes map[restic.ID]uint) (*dir, error) {
...
func newDirFromSnapshot(repo restic.Repository, snapshot SnapshotWithId, ownerIsRoot bool, sizes map[restic.ID]uint) (*dir, error) {
...
func (d *dir) Lookup(ctx context.Context, name string) (fs.Node, error) {
	...
	switch node.Type {
	case "dir":
		return newDir(d.repo, node, d.ownerIsRoot, d.sizes)
	case "file":
